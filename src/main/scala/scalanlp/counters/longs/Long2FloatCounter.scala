...
trait Long2FloatCounter extends FloatCounter[Long] {
  ...
  */
  ...
  override def default(k : Long) : Float = defaultValue;
...
object Long2FloatCounter {
  ...
  @serializable
  @SerialVersionUID(2L)
  class FastMapCounter(override val defaultValue: Float) extends MapWrapper[Long,Float] with Long2FloatCounter {
