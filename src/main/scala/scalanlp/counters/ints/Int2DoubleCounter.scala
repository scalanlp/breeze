...
trait Int2DoubleCounter extends DoubleCounter[Int] {
  ...
  override def ++=(kv: Iterable[(Int,Double)]) = kv.foreach(+=);
  ...
  */
  ...
  override def default(k : Int) : Double = defaultValue;
   ...
   */
  override  def topK(k : Int) = Counters.topK[(Int,Double)](k,(x,y) => if(x._2 < y._2) -1 else if (x._2 == y._2) 0 else 1)(this);
  ...
  override  def unary_-() = {
      val rv : DoubleCounter[Int] = Int2DoubleCounter();
      rv -= this;
      rv;
  }
}
...
object Int2DoubleCounter {
  ...
  @serializable
  @SerialVersionUID(2L)
  class FastMapCounter(override val defaultValue: Double) extends MapWrapper[Int,Double] with Int2DoubleCounter {
