...
trait Int2FloatCounter extends FloatCounter[Int] {
  ...
  override def ++=(kv: Iterable[(Int,Float)]) = kv.foreach(+=);
  ...
  */
  ...
  override def default(k : Int) : Float = defaultValue;

  override  protected def defaultValue: Float = 0;
   ...
   */
  override  def topK(k : Int) = Counters.topK[(Int,Float)](k,(x,y) => if(x._2 < y._2) -1 else if (x._2 == y._2) 0 else 1)(this);
  ...
  override  def unary_-() = {
      val rv : FloatCounter[Int] = Int2FloatCounter();
      rv -= this;
      rv;
  }
}
...
object Int2FloatCounter {
  ...
  @serializable
  @SerialVersionUID(2L)
  class FastMapCounter(override val defaultValue: Float) extends MapWrapper[Int,Float] with Int2FloatCounter {
  ...
  def withDefaultValue(d: Float) = new FastMapCounter(d);
