...
trait Double2ShortCounter extends ShortCounter[Double] {
  ...
  */
  ...
  override def default(k : Double) : Short = defaultValue;
  ...
  override  def unary_-() = {
      val rv : ShortCounter[Double] = Double2ShortCounter();
      rv -= this;
      rv;
  }
}
...
object Double2ShortCounter {
  ...
  @serializable
  @SerialVersionUID(2L)
  class FastMapCounter(override val defaultValue: Short) extends MapWrapper[Double,Short] with Double2ShortCounter {
