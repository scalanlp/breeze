...
trait Double2LongCounter extends LongCounter[Double] {
  ...
  */
  ...
  override def default(k : Double) : Long = defaultValue;
  ...
  override  def unary_-() = {
      val rv : LongCounter[Double] = Double2LongCounter();
      rv -= this;
      rv;
  }
}
...
object Double2LongCounter {
  ...
  @serializable
  @SerialVersionUID(2L)
  class FastMapCounter(override val defaultValue: Long) extends MapWrapper[Double,Long] with Double2LongCounter {
