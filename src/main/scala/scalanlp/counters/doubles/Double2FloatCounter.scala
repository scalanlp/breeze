...
trait Double2FloatCounter extends FloatCounter[Double] {
  ...
  */
  ...
  override def default(k : Double) : Float = defaultValue;
  ...
  override  def unary_-() = {
      val rv : FloatCounter[Double] = Double2FloatCounter();
      rv -= this;
      rv;
  }
}
...
object Double2FloatCounter {
  ...
  @serializable
  @SerialVersionUID(2L)
  class FastMapCounter(override val defaultValue: Float) extends MapWrapper[Double,Float] with Double2FloatCounter {
