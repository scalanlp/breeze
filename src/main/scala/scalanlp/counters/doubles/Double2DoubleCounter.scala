...
trait Double2DoubleCounter extends DoubleCounter[Double] {
  ...
  */
  ...
  override def default(k : Double) : Double = defaultValue;
  ...
  override  def unary_-() = {
      val rv : DoubleCounter[Double] = Double2DoubleCounter();
      rv -= this;
      rv;
  }
}
...
object Double2DoubleCounter {
  ...
  @serializable
  @SerialVersionUID(2L)
  class FastMapCounter(override val defaultValue: Double) extends MapWrapper[Double,Double] with Double2DoubleCounter {
