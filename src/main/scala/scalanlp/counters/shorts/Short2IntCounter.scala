...
trait Short2IntCounter extends IntCounter[Short] {
  ...
  */
  ...
  override def default(k : Short) : Int = defaultValue;
  ...
  override  def unary_-() = {
      val rv : IntCounter[Short] = Short2IntCounter();
      rv -= this;
      rv;
  }
}
...
object Short2IntCounter {
  ...
  @serializable
  @SerialVersionUID(2L)
  class FastMapCounter(override val defaultValue: Int) extends MapWrapper[Short,Int] with Short2IntCounter {
