...
trait Short2LongCounter extends LongCounter[Short] {
  ...
  */
  ...
  override def default(k : Short) : Long = defaultValue;
  ...
  override  def unary_-() = {
      val rv : LongCounter[Short] = Short2LongCounter();
      rv -= this;
      rv;
  }
}
...
object Short2LongCounter {
  ...
  @serializable
  @SerialVersionUID(2L)
  class FastMapCounter(override val defaultValue: Long) extends MapWrapper[Short,Long] with Short2LongCounter {
