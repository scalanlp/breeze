...
trait Short2FloatCounter extends FloatCounter[Short] {
  ...
  override def ++=(kv: Iterable[(Short,Float)]) = kv.foreach(+=);
  ...
  */
  ...
  override def default(k : Short) : Float = defaultValue;
   ...
   */
  override  def topK(k : Int) = Counters.topK[(Short,Float)](k,(x,y) => if(x._2 < y._2) -1 else if (x._2 == y._2) 0 else 1)(this);
  ...
  override  def unary_-() = {
      val rv : FloatCounter[Short] = Short2FloatCounter();
      rv -= this;
      rv;
  }
}
...
object Short2FloatCounter {
  ...
  @serializable
  @SerialVersionUID(2L)
  class FastMapCounter(override val defaultValue: Float) extends MapWrapper[Short,Float] with Short2FloatCounter {
