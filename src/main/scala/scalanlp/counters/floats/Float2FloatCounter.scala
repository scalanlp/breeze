...
trait Float2FloatCounter extends FloatCounter[Float] {
  ...
  */
  ...
  override def default(k : Float) : Float = defaultValue;
  ...
  override  def unary_-() = {
      val rv : FloatCounter[Float] = Float2FloatCounter();
      rv -= this;
      rv;
  }
}
...
object Float2FloatCounter {
  ...
  @serializable
  @SerialVersionUID(2L)
  class FastMapCounter(override val defaultValue: Float) extends MapWrapper[Float,Float] with Float2FloatCounter {
