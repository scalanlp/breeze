...
object Database {
  ...
  def value(regex: Regex) = databaseHM.filter(
    (key: (String, (Double, Double, String))) => regex.findFirstIn(key._1).isInstanceOf[Some]
  ...
  private lazy val databaseHM = HashMap[String, (Double, Double, String)](
    ...
    ("""Angstrom star""",  ( 1.00001495E-10, 9.E-17, """m""")),
    ...
    ("""atomic mass unit-electron volt relationship""",  ( 9.31494061E8, 21., """eV""")),
    ...
    ("""atomic mass unit-inverse meter relationship""",  ( 7.5130066042E14, 530000., """m^-1""")),
    ...
    ("""atomic unit of electric potential""",  ( 27.21138505, 6.E-7, """V""")),
    ...
    ("""atomic unit of mass""",  ( 9.10938291E-31, 4.E-38, """kg""")),
    ...
    ("""Bohr magneton""",  ( 9.27400968E-24, 2.E-31, """J T^-1""")),
    ("""Bohr magneton in eV/T""",  ( 0.0000578838180660, 3.8E-14, """eV T^-1""")),
    ("""Bohr magneton in Hz/T""",  ( 1.399624555E10, 310.0, """Hz T^-1""")),
    ("""Bohr magneton in inverse meters per tesla""",  ( 46.68644980, 1.E-6, """m^-1 T^-1""")),
    ...
    ("""deuteron mag. mom.""",  ( 4.33073489E-27, 1.E-34, """J T^-1""")),
    ...
    ("""electron charge to mass quotient""",  ( -1.758820088E11, 3900., """C kg^-1""")),
    ...
    ("""electron gyromag. ratio""",  ( 1.760859708E11, 3900., """s^-1 T^-1""")),
    ...
    ("""electron mass""",  ( 9.10938291E-31, 4.E-38, """kg""")),
    ...
    ("""electron to shielded helion mag. mom. ratio""",  ( 864.0582570, 1.E-5, """""")),
    ...
    ("""Fermi coupling constant""",  ( 0.000011663640, 5.E-11, """GeV^-2""")),
    ...
    ("""hartree-electron volt relationship""",  ( 27.21138505, 6.E-7, """eV""")),
    ("""Hartree energy""",  ( 4.35974434E-18, 1.9E-25, """J""")),
    ("""Hartree energy in eV""",  ( 27.21138505, 6.E-7, """eV""")),
    ...
    ("""helion-electron mass ratio""",  ( 5495.88527540, 5.E-6, """""")),
    ("""helion g factor""",  ( -4.255250613, 5.E-8, """""")),
    ...
    ("""helion mass energy equivalent""",  ( 4.49953902E-10, 2.E-17, """J""")),
    ...
    ("""molar volume of ideal gas (273.15 K, 101.325 kPa)""",  ( 0.022413968, 2.E-8, """m^3 mol^-1""")),
    ("""molar volume of silicon""",  ( 0.00001205883301, 8.E-13, """m^3 mol^-1""")),
    ("""Mo x unit""",  ( 1.00209952E-13, 5.3E-20, """m""")),
    ("""muon Compton wavelength""",  ( 1.173444103E-14, 3.E-22, """m""")),
    ...
    ("""natural unit of mass""",  ( 9.10938291E-31, 4.E-38, """kg""")),
    ...
    ("""neutron g factor""",  ( -3.826085450, 9.E-7, """""")),
    ("""neutron gyromag. ratio""",  ( 1.83247179E8, 43., """s^-1 T^-1""")),
    ...
    ("""Newtonian constant of gravitation""",  ( 6.67384E-11, 8.E-15, """m^3 kg^-1 s^-2""")),
    ("""Newtonian constant of gravitation over h-bar c""",  ( 6.70837E-39, 8.E-43, """(GeV/c^2)^-2""")),
    ...
    ("""proton gyromag. ratio over 2 pi""",  ( 42.57748060, 1.E-6, """MHz T^-1""")),
    ...
    ("""proton mass in u""",  ( 1.0072764668120, 9.E-11, """u""")),
    ("""proton molar mass""",  ( 0.0010072764668120, 9.E-14, """kg mol^-1""")),
    ...
    ("""Rydberg constant times hc in eV""",  ( 13.60569253, 3.E-7, """eV""")),
    ...
    ("""shielded proton gyromag. ratio over 2 pi""",  ( 42.57638660, 1.E-6, """MHz T^-1""")),
    ...
    ("""triton-electron mass ratio""",  ( 5496.92152670, 5.E-6, """""")),
    ...
    ("""triton mass energy equivalent""",  ( 4.50038741E-10, 2.E-17, """J""")),
