...
object EnforceUFuncCoverage {
  ...
  implicit def wVectors1[F <: UFunc](implicit opV: UFunc.UImpl[F, Vector[Double], Any],
  ...
  implicit def wMatrices1[F <: UFunc](implicit opV: UFunc.UImpl[F, Matrix[Double], Any],
  ...
  implicit def wCounters1[F <: UFunc](implicit opC: UFunc.UImpl[F, Counter[String, Double], Any],
  ...
  implicit def linalg1[F <: UFunc](f: F)(implicit wV: Witness[F, One, Vector.type],
