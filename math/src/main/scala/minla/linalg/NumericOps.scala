...
import minla.linalg.operators._
import minla.hierarchy.{Field, VectorSpace}
...
trait NumericOps[+This] {
  ...
  final def dot [TT>:This,B,That](b : B)(implicit op : BinaryOp[TT,B,OpMulInner,That]) = op(repr,b)
