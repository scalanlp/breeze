...
class DormandPrince54Integrator(
  ...
  protected final val inner = new ApacheDormandPrince54Integrator(minStep, maxStep, ApacheAdaptiveStepIntegrator.defaultAbsTol, ApacheAdaptiveStepIntegrator.defaultRelTol)
}