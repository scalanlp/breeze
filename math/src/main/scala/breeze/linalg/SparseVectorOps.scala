...
trait SparseVectorOps_Double { this: SparseVector.type =>
  ...
  class canAxpy_SV_SV_Double private[linalg] () extends CanAxpy[Double, SparseVector[Double], SparseVector[Double]] {
    def apply(s: Double, b: SparseVector[Double], a: SparseVector[Double]) {
      if(s == 0) return;
      require(b.length == a.length, "Vectors must be the same length!")
...
trait SparseVectorOps_Float { this: SparseVector.type =>
  ...
  class canAxpy_SV_SV_Float private[linalg] () extends CanAxpy[Float, SparseVector[Float], SparseVector[Float]] {
    def apply(s: Float, b: SparseVector[Float], a: SparseVector[Float]) {
      if(s == 0) return;
      require(b.length == a.length, "Vectors must be the same length!")
...
trait SparseVectorOps_Int { this: SparseVector.type =>
  ...
  class canAxpy_SV_SV_Int private[linalg] () extends CanAxpy[Int, SparseVector[Int], SparseVector[Int]] {
    def apply(s: Int, b: SparseVector[Int], a: SparseVector[Int]) {
      if(s == 0) return;
      require(b.length == a.length, "Vectors must be the same length!")
...
/** This is an auto-generated trait providing operators for SparseVector */
trait SparseVectorOps_Complex { this: SparseVector.type =>

  def pureFromUpdate_Complex[Other,Op<:OpType](op: BinaryUpdateOp[SparseVector[Complex], Other, Op])(implicit copy: CanCopy[SparseVector[Complex]]):BinaryOp[SparseVector[Complex], Other, Op, SparseVector[Complex]] = {
    new BinaryOp[SparseVector[Complex], Other, Op, SparseVector[Complex]] {
      override def apply(a : SparseVector[Complex], b : Other) = {
        val c = copy(a)
        op(c, b)
        c
      }
  ...
  class canDivInto_VV_Complex private[linalg] () extends BinaryUpdateOp[SparseVector[Complex], SparseVector[Complex], breeze.linalg.operators.OpDiv] {
  ...
  implicit val canDivInto_VV_Complex = new canDivInto_VV_Complex ()
    
  Vector.canDivInto_V_V_Complex.register(canDivInto_VV_Complex)

  implicit val canDiv_VV_Complex: BinaryOp[SparseVector[Complex], SparseVector[Complex], breeze.linalg.operators.OpDiv, SparseVector[Complex]] = pureFromUpdate_Complex(canDivInto_VV_Complex)
  Vector.canDiv_V_V_Complex.register(canDiv_VV_Complex)


  class canDivInto_SV_S_Complex private[linalg] () extends BinaryUpdateOp[SparseVector[Complex], Complex, breeze.linalg.operators.OpDiv] {
  ...
  implicit val canDivInto_SV_S_Complex = new canDivInto_SV_S_Complex ()
    
  Vector.canDivInto_V_S_Complex.register(canDivInto_SV_S_Complex)
  ...
  implicit val canSubInto_VV_Complex = new canSubInto_VV_Complex ()
    
  Vector.canSubInto_V_V_Complex.register(canSubInto_VV_Complex)

  implicit val canSub_VV_Complex: BinaryOp[SparseVector[Complex], SparseVector[Complex], breeze.linalg.operators.OpSub, SparseVector[Complex]] = pureFromUpdate_Complex(canSubInto_VV_Complex)
  Vector.canSub_V_V_Complex.register(canSub_VV_Complex)


  class canSubInto_SV_S_Complex private[linalg] () extends BinaryUpdateOp[SparseVector[Complex], Complex, breeze.linalg.operators.OpSub] {
    def apply(a: SparseVector[Complex], b: Complex) {
  ...
  implicit val canSubInto_SV_S_Complex = new canSubInto_SV_S_Complex ()
    
  Vector.canSubInto_V_S_Complex.register(canSubInto_SV_S_Complex)

  implicit val canSub_SV_S_Complex: BinaryOp[SparseVector[Complex], Complex, breeze.linalg.operators.OpSub, SparseVector[Complex]] = pureFromUpdate_Complex(canSubInto_SV_S_Complex)
  ...
  implicit val canPowInto_VV_Complex = new canPowInto_VV_Complex ()
    
  Vector.canPowInto_V_V_Complex.register(canPowInto_VV_Complex)

  implicit val canPow_VV_Complex: BinaryOp[SparseVector[Complex], SparseVector[Complex], breeze.linalg.operators.OpPow, SparseVector[Complex]] = pureFromUpdate_Complex(canPowInto_VV_Complex)
  Vector.canPow_V_V_Complex.register(canPow_VV_Complex)


  class canPowInto_SV_S_Complex private[linalg] () extends BinaryUpdateOp[SparseVector[Complex], Complex, breeze.linalg.operators.OpPow] {
    def apply(a: SparseVector[Complex], b: Complex) {
  ...
  implicit val canPowInto_SV_S_Complex = new canPowInto_SV_S_Complex ()
    
  Vector.canPowInto_V_S_Complex.register(canPowInto_SV_S_Complex)

  implicit val canPow_SV_S_Complex: BinaryOp[SparseVector[Complex], Complex, breeze.linalg.operators.OpPow, SparseVector[Complex]] = pureFromUpdate_Complex(canPowInto_SV_S_Complex)
  Vector.canPow_V_S_Complex.register(canPow_SV_S_Complex)
  ...
  class canMulScalarInto_VV_Complex private[linalg] () extends BinaryUpdateOp[SparseVector[Complex], SparseVector[Complex], breeze.linalg.operators.OpMulScalar] {
    ...
    val outD = new Array[Complex](a.activeSize min b.activeSize)
    val outI = new Array[Int](a.activeSize min b.activeSize)
    var out = 0
  ...
  implicit val canMulScalarInto_VV_Complex = new canMulScalarInto_VV_Complex ()
    


   class canMulScalar_VV_Complex private[linalg] () extends BinaryOp[SparseVector[Complex], SparseVector[Complex], breeze.linalg.operators.OpMulScalar, SparseVector[Complex]] {
    def apply(a: SparseVector[Complex], b: SparseVector[Complex]) = {
      require(b.length == a.length, "Vectors must be the same length!")
  ...
  class canMulScalarInto_SV_S_Complex private[linalg] () extends BinaryUpdateOp[SparseVector[Complex], Complex, breeze.linalg.operators.OpMulScalar] {
    def apply(a: SparseVector[Complex], b: Complex) {
  ...
  implicit val canMulScalarInto_SV_S_Complex = new canMulScalarInto_SV_S_Complex ()
    

  implicit val canMulScalar_SV_S_Complex: BinaryOp[SparseVector[Complex], Complex, breeze.linalg.operators.OpMulScalar, SparseVector[Complex]] = pureFromUpdate_Complex(canMulScalarInto_SV_S_Complex)


  class canMulMatrixInto_SV_S_Complex private[linalg] () extends BinaryUpdateOp[SparseVector[Complex], Complex, breeze.linalg.operators.OpMulMatrix] {
    def apply(a: SparseVector[Complex], b: Complex) {
  ...
  implicit val canMulMatrixInto_SV_S_Complex = new canMulMatrixInto_SV_S_Complex ()
    

  implicit val canMulMatrix_SV_S_Complex: BinaryOp[SparseVector[Complex], Complex, breeze.linalg.operators.OpMulMatrix, SparseVector[Complex]] = pureFromUpdate_Complex(canMulMatrixInto_SV_S_Complex)


  class canAxpy_SV_SV_Complex private[linalg] () extends CanAxpy[Complex, SparseVector[Complex], SparseVector[Complex]] {
    def apply(s: Complex, b: SparseVector[Complex], a: SparseVector[Complex]) {
      if(s == 0) return;
      require(b.length == a.length, "Vectors must be the same length!")
  ...
  implicit val canAxpy_SV_SV_Complex = new canAxpy_SV_SV_Complex ()
   ...
   class canDotProductSV_Complex private[linalg] () extends BinaryOp[SparseVector[Complex], SparseVector[Complex], breeze.linalg.operators.OpMulInner, Complex] {
    def apply(a: SparseVector[Complex], b: SparseVector[Complex]) = {
      require(b.length == a.length, "Vectors must be the same length!")
  ...
  }; implicit val canDotProductSV_Complex = new canDotProductSV_Complex ()
