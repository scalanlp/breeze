...
trait BitVectorOps {
  ...
  @expand
  @expand.valify
  implicit def bv_bv_UpdateOp[@expand.args(OpAnd, OpOr, OpXor, OpSet) Op <: OpType](implicit
      @expand.sequence[Op](
        { _.and(_) },
        { _.or(_) },
        { _.xor(_) },
  ...
  @expand
  @expand.valify
  implicit def canDot_BV_DenseVector[@expand.args(Double, Float, Int, Long) T](implicit
      @expand.sequence[T](0.0, 0.0f, 0, 0L) zero: T
