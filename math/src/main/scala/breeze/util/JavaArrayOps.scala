...
/**Companion object to facilitate java calls*/
class JavaArrayOps

/**This utility object facilitates transparent access of breeze data objects from plain Java without Scala-related Generic complications.
 * @author ktakagaki
 * @date 03/20/2014.
 */
object JavaArrayOps {
