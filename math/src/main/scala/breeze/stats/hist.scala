...
object hist extends UFunc {
  ...
  implicit def defaultHist[T, S](implicit
      iter: CanTraverseValues[T, S],
      innerImpl: Impl2[T, Int, Histogram[S]]
  ): Impl[T, Histogram[S]] =
  ...
  @expand
  implicit def defaultHistBins[T, @expand.args(Int, Double, Float, Long) S](implicit
      iter: CanTraverseValues[T, S]
  ): Impl2[T, Int, Histogram[S]] =
  ...
  @expand
  implicit def canTraverseValuesImpl[T, @expand.args(Int, Double, Float, Long) S](implicit
      iter: CanTraverseValues[T, S]
  ...
  @expand
  implicit def defaultHistWeights[T, U, @expand.args(Int, Double, Float, Long) S](implicit
      iter: CanZipAndTraverseValues[T, U, S, S],
      iter2: CanTraverseValues[T, S]
  ): Impl2[T, U, Histogram[S]] =
  ...
  @expand
  implicit def defaultHistBinsWeights[T, U, @expand.args(Int, Double, Float, Long) S](implicit
      iter: CanZipAndTraverseValues[T, U, S, S],
      iter2: CanTraverseValues[T, S]
  ): Impl3[T, Int, U, Histogram[S]] =
  ...
  @expand
  implicit def canTraverseValuesImplWeighted[T, U, @expand.args(Int, Double, Float, Long) S](implicit
      iter: CanZipAndTraverseValues[T, U, S, S]
